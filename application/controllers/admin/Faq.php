...
class Faq extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('admin/setting/faq_model', 'data');

        $this->compid = 'admin/faq/';
    }
    ...
    public function index() {
        ...
        $this->load->view('admin/module/data/faq/index', $data);
    ...
    public function add() {
        ...
        $this->load->view('admin/templates/sidemenu', $data);
        $this->load->view('admin/templates/sidenav', $data);
        $this->load->view('admin/module/data/faq/add', $data);
        $this->load->view('admin/templates/footer', $data);
        $this->load->view('admin/templates/fscript-html-end', $data);
    }
    ...
    public function edit($id = null) {
        ...
        $dataedit = $this->db->get_where('m_faq', ['faq_id' => $id]);
        ...
        $this->load->view('admin/templates/sidemenu', $data);
        $this->load->view('admin/templates/sidenav', $data);
        $this->load->view('admin/module/data/faq/edit', $data);
        $this->load->view('admin/templates/footer', $data);
        $this->load->view('admin/templates/fscript-html-end', $data);
    }
    ...
    public function hapus($id){
        $dataedit = $this->db->get_where('m_faq', ['faq_id' => $id])->row_array();
        $check = $this->other->check_access_del();
        if ($check==true) {
            $res = $this->db->delete('m_faq', ['faq_id' => $id]);
        }
