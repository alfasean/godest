...
<div class="hero hero-search" id="hero">
		<div class="container">
								...
								<form class="form transparent-form" action="<?=base_url('s?');?>" method="GET">
									<div class="row mb-2">
										<div class="col-sm-12 col-md-12 mb-3 mb-lg-0 col-lg-6">
											<input type="text" class="form-control" name="slug" value="<?=$v_slug;?>" placeholder="Cari tempat wisata disini...">
										</div>
										<div class="col-sm-12 col-md-6 mb-3 mb-lg-0 col-lg-3">
											<select name="provinsi" class="form-control custom-select" onChange="getSubcategory(this.value)">
												...
												<option value="<?=$row['id'];?>" <?php if ($row['id']==$v_provinsi) echo 'selected'; ?>><?=$row['name'];?></option>
												<?php endforeach; ?>
											</select>
										</div>
										<div class="col-sm-12 col-md-6 mb-3 mb-lg-0 col-lg-3">
	...
	<div class="untree_co-section">
		<div class="container">
			<div class="row justify-content-center text-center mb-5">
				<div class="col-lg-6">
					<h2 class="section-title text-center mb-3">Hasil Pencarian Anda</h2>
				</div>
			</div>
    ...
    <script type="text/javascript">
		$(document).ready(function() { 
			<?php if($v_provinsi!=''): ?>
                getSubcategory('<?=$v_provinsi;?>','<?=$v_kabkota;?>');
            <?php endif; ?>
		});
	</script>