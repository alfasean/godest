...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    ...
    <div class="card">
      <form class="card-body" action="<?=base_url('admin/faq/edit_proses/'.$edit['faq_id']);?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3">
          <div class="col-xl-12 col-md-12 col-sm-12">
            ...
            <input type="text" class="form-control" name="nama" value="<?=$edit['nama_faq'];?>" placeholder="..." required autocomplete="off" />
          </div>
